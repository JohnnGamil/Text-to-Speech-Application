...
#icon
# root.iconbitmap(bitmap="./imgs/speaker-logo.ico")
image_icon = PhotoImage(file="./imgs/speak.png")
...
logo = PhotoImage(file="./imgs/speaker logo.png")
...
text_area = Text(root,font="Robote 20",bg="white",relief=RAISED,wrap=WORD)
text_area.place(x=19,y=150,width=500,height=250)
